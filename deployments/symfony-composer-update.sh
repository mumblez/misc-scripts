...
CODE_FREEZE_ROOT="/srv/codefreeze"
COMPOSER="$CODE_FREEZE_ROOT/binaries/composer.phar"
...
git config --global -l | grep "user.name" && die "ERROR: git user is already configured on this server"
