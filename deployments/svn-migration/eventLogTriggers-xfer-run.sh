...
#EXEC_JOB_ID="bb2c2b76-4901-46f0-9719-6a17184a058b" # https://rundeck.dev.cognolink.com/project/Everything/jobs/snippets/misc/deployments/phase1 (6-eventLogTriggers-run)
...
# call another RD job, which itself set's HOME=/root and runs the triggers.sql file
